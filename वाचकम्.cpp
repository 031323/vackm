...
public:
	...
	सङ्ख्या कण्ठ्यम्=0;
	सङ्ख्या कण्ठ्यान्तरम्=1/120.0,पूर्वकण्ठ्यान्तरम्=1/120.0,नवकण्ठ्यान्तरम्=पाठः.पठनम्().second==0?1/अनुदात्तस्य:उदात्तस्य;
	struct
	{
...
auto वर्णनिर्णयः(const char* पाठः)
{
	...
	for(auto लक्षणपदम्=स्वराः.begin(); लक्षणपदम्!=स्वराः.end(); ++लक्षणपदम्) {
		...
		if(*लक्षणपदम्==स्वरलक्षणम् && (पश्चिमम्==स्वराः.end() || *पश्चिमम्==स्वरलक्षणम्))
			*लक्षणपदम् = गतिः;
	...
	स्वराः.erase(std::remove_if(स्वराः.begin(), स्वराः.end(), [](auto const स्वरः){
		return स्वरः==स्वरलक्षणम्||स्वरः==स्वरितलक्षणम्||स्वरः==अनुदात्तलक्षणम्;
	}), स्वराः.end());
	गतिः = स्वराः.front()==अनुदात्तः?0:2;
	auto स्वरपदम्=स्वराः.begin();
	for(auto वर्णपदम्=वर्णाः.begin(); वर्णपदम्!=वर्णाः.end(); ++वर्णपदम्) {
...
int main(int argc,char *argv[])
{
	...
	auto वर्णस्वराः=वर्णनिर्णयः(रामायणम्);
