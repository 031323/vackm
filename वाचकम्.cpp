...
public:
	...
	void प्रभावः()
	{
		...
		if(प्रयत्नः.कण्ठ्यम्)
		{
			...
			{
				if(कालः-कण्ठ्यकालः<कण्ठ्यान्तरम्+कण्ठ्यान्तरम्)कण्ठ्यकालः+=कण्ठ्यान्तरम्*(1.0+0.02*(double)rand()/(double)RAND_MAX);
...
int main(int argc,char *argv[])
{
	...
	auto वर्णस्वराः=वर्णनिर्णयः(s.c_str());
	...
	auto क्रमणम्=[&क्रमः,&स्थानम्,&स्वरक्रमः,&स्वरस्थानम्]()
	{
		...
		if(स्थानम्==क्रमः.end())
		{
			if(!std::cin.eof())
			{
				...
				std::cin>>s;
				auto वर्णस्वराः=वर्णनिर्णयः(s.c_str());
				स्थानम्=++वर्णस्वराः.first.begin();
				स्वरस्थानम्=++वर्णस्वराः.second.begin();
				क्रमः.splice(क्रमः.end(),वर्णस्वराः.first);
				स्वरक्रमः.splice(स्वरक्रमः.end(),वर्णस्वराः.second);
			}
			else
			{
				स्थानम्=क्रमः.begin();स्वरस्थानम्=स्वरक्रमः.begin();
			}
		}
